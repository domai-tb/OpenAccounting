...
- The proposed boundary is coherent: UStVA, EÜR, EKS scope, and durable export behavior are grouped as reporting correctness and handoff.
- The delta contains 4 requirement(s) and 10 named scenario(s), with both success and failure or edge coverage where the capability has a runtime surface.
