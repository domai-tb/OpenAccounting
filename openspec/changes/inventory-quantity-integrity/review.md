...
- The proposed boundary is coherent: Decimal quantity preservation is a focused storage/consumer invariant.
- The delta contains 1 requirement(s) and 2 named scenario(s), with both success and failure or edge coverage where the capability has a runtime surface.
