...
- The proposed boundary is coherent: PDF generation, profile-local storage, reopening, printing, saving, and dunning artifact output form one artifact lifecycle.
