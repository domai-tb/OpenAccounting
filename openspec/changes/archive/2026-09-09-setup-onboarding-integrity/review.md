...
- The proposed boundary is coherent: Setup navigation, atomic persistence, opening accounting, and first-run concepts are one onboarding contract.
- The delta contains 3 requirement(s) and 6 named scenario(s), with both success and failure or edge coverage where the capability has a runtime surface.
