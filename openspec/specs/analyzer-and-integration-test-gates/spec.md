...
Maintain trustworthy static-analysis and production-composition gates for release readiness.

## Requirements

### Requirement: Pinned analysis is clean

The repository MUST pass `fvm flutter analyze` with zero diagnostics under the pinned Flutter version, including removal or replacement of deprecated lint rules and unused or dead production paths.
